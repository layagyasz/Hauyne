...
namespace Hauyne
{
	public class Language
	{
		...
		Dictionary<string, Generator<Sound>> _Generators = new Dictionary<string, Generator<Sound>>() { { "*", new Set<Sound>() }, { "~", new Set<Sound>() } };
		...
		public Word Generate(string Generator, Random Random)
		{
			Word W = new Word(_Generators[Generator].Generate(Random), Random, _Printers);
			W.RemoveDoubles();
